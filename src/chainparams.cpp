...
public:
    CMainParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = list_of(23); // A prefix
        base58Prefixes[SCRIPT_ADDRESS] = list_of(25); // B prefix
        base58Prefixes[SECRET_KEY] =     list_of(45); // 7 prefix
        base58Prefixes[EXT_PUBLIC_KEY] = list_of(0x04)(0x88)(0xEE)(0x23);
